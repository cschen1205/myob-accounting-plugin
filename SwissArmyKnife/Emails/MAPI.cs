...
namespace SwissArmyKnife.Emails
{
    public class MAPI
    {
        ...
        public int SendMailPopup(string strSubject, string strBody, out string error)
        {
            return SendMail(strSubject, strBody, MAPI_LOGON_UI | MAPI_DIALOG, out error);
        }

        public int SendMailDirect(string strSubject, string strBody, out string error)
        {
            return SendMail(strSubject, strBody, MAPI_LOGON_UI, out error);
        }
        ...
        int SendMail(string strSubject, string strBody, int how, out string error)
        {
            ...
            error="";
            if (m_lastError > 1)
                error="MAPISendMail failed! " + GetLastError();
