...
namespace System.Windows.Forms
{
	...
	public abstract class TabStyleProvider : Component
	{
		...
		protected TabStyleProvider(CZTabControl tabControl){
		...
		public static TabStyleProvider CreateProvider(CZTabControl tabControl){
		...
		protected CZTabControl _TabControl;
