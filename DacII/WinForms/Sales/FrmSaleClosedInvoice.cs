...
namespace DacII.WinForms.Sales
{
    ...
    public partial class FrmSaleClosedInvoice : BaseView
    {
        private BOSaleClosedInvoice mModel;
        private BOViewModel mViewModel;

        public FrmSaleClosedInvoice(ApplicationPresenter ap, BOSaleClosedInvoice model)
            : base(ap)
        {
            InitializeComponent();
        ...
        public BOSaleClosedInvoice Model
        {
            set
            {
                mModel = value;
        ...
        {
            cboCustomer.DataSource = mApplicationController.FindAllComments();
