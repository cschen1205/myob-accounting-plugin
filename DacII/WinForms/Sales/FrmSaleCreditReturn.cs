...
namespace DacII.WinForms.Sales
{
    ...
    public partial class FrmSaleCreditReturn : BaseView
    {
        private BOSaleCreditReturn mModel;
        ...
        public BOSaleCreditReturn Model
        {
            set
            {
                mModel = value;
        ...
        private void Record(object sender, EventArgs args)
        {
            if (mViewModel.ValidateModel())
            {
                ...
                {
                    MessageBox.Show(result.Error, "Update Sale Credit Return Failed");
                    DialogResult = DialogResult.None;
                }
                else if (result.Status == OpResult.ResultStatus.CreateFailedOnCriteria)
                {
                    MessageBox.Show(result.Error, "Create Sale Credit Return Failed");
                    DialogResult = DialogResult.None;
                }
                else
                {
                    ...
                    {
                        MessageBox.Show("Sale Credit Return Recorded!");
                    }
                    else
                    {
