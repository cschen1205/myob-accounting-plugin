...
namespace DacII.WinForms.Sales.SaleLines.Items
{
    public partial class FrmSearchSoldItem : Form
    {
        public FrmSearchSoldItem()
        {
            InitializeComponent();
        }

        private void FrmSearchSoldItem_Load(object sender, EventArgs e)
        {
            /*
